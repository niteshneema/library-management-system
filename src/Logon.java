...
public class Logon extends JFrame implements ActionListener {
	...
	public Logon () {
		...
		try {
			...
			String loc = "jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ="+new File(Logon.class.getResource("/DataBase/Library.mdb").
					getPath().replace("%20", " ")).getAbsolutePath();
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == btnOk || obj == txtPass) {		//If OK Button Pressed or Pressed Enter.
