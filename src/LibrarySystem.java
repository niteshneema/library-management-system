...
//		Creating All the MenuItems of Program.
		...
		end = new JMenuItem ("Quit Library System?");
	...
	btnNewBook = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/Actions-address-book-new-icon.png")));
	btnNewBook.setToolTipText ("Add New Book");
	btnNewBook.addActionListener (this);
	btnNewMember = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/Actions-contact-new-icon.png")));
	btnNewMember.setToolTipText ("Add New Member");
	btnNewMember.addActionListener (this);
	btnIssue = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/Back-icon.png")));
	btnIssue.setToolTipText ("Issue Book");
	btnIssue.addActionListener (this);
	btnReturn = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/Actions-mail-receive-icon.png")));
	btnReturn.setToolTipText ("Return Book");
	btnReturn.addActionListener (this);
	
	
	btnDelBook = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/Delete-icon.png")));
	btnDelBook.setToolTipText ("Delete Book");
	btnDelBook.addActionListener (this);
	btnDelMember = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/General-Delete-icon.png")));
	btnDelMember.setToolTipText ("Delete Member");
	btnDelMember.addActionListener (this);
	btnFindBook = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/search-b-icon.png")));
	btnFindBook.setToolTipText ("Search Book");
	btnFindBook.addActionListener (this);
	btnFindMember = new JButton (new ImageIcon(LibrarySystem.class.getResource("/newFolder/Actions-edit-find-user-icon.png")));
	btnFindMember.setToolTipText ("Search Member");
	btnFindMember.addActionListener (this);
	
	
	btnKey = new JButton (new ImageIcon(LibrarySystem.class.getResource("/Images/Keys.png")));
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == newBook || obj == book || obj == btnNewBook) {
			...
			if (b == false) {
				LibraryHelp hlpKey = new LibraryHelp ("LibrarySystem Keys", new File(LibrarySystem.class.getResource("Help/Keys.htm").getPath()).getAbsolutePath());
				desktop.add (hlpKey);
				hlpKey.show ();
			} 
			...
			String msg = "Library System\n\n" + "Created & Designed By:\n" + 
				"Anvesh and Ayush\n\n" + "E-mail me:\nteamkingslayer@gmail.com";
